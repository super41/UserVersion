...
public class PackageAdapter extends RecyclerView.Adapter{
    ...
    public PackageAdapter(Context context,List<Package> list){
        ...
        colorPink=context.getResources().getColor(R.color.card_pink);
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
            ...
            h.card.setCardBackgroundColor( pg.isDelivery() ? colorPink : colorGreen);
            h.btn_connect.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    WifiConnectActivity.startTrans(mContext,pg);
                }
            });
